...
#include "Tower_Ascend/MovingPlatform.h"
...
// Cross Module References
	...
	TOWER_ASCEND_API UClass* Z_Construct_UClass_AMovingPlatform();
	TOWER_ASCEND_API UClass* Z_Construct_UClass_AMovingPlatform_NoRegister();
...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TravelLimit_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_TravelLimit;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMovingPlatform_Statics::NewProp_TravelLimit_MetaData[] = {
		{ "Category", "Moving Platform" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingPlatform_Statics::NewProp_TravelLimit = { "TravelLimit", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMovingPlatform, TravelLimit), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AMovingPlatform_Statics::NewProp_TravelLimit_MetaData), Z_Construct_UClass_AMovingPlatform_Statics::NewProp_TravelLimit_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMovingPlatform_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMovingPlatform_Statics::NewProp_TravelLimit,
	...
	template<> TOWER_ASCEND_API UClass* StaticClass<AMovingPlatform>()
	{
		return AMovingPlatform::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AMovingPlatform);
	AMovingPlatform::~AMovingPlatform() {}
	struct Z_CompiledInDeferFile_FID_Users_FMurtagh_Desktop_TowerAscend_ObstaclesCourse_CA_Tower_Ascend_Source_Tower_Ascend_MovingPlatform_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_FMurtagh_Desktop_TowerAscend_ObstaclesCourse_CA_Tower_Ascend_Source_Tower_Ascend_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 2286076052U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_FMurtagh_Desktop_TowerAscend_ObstaclesCourse_CA_Tower_Ascend_Source_Tower_Ascend_MovingPlatform_h_2445923441(TEXT("/Script/Tower_Ascend"),
		Z_CompiledInDeferFile_FID_Users_FMurtagh_Desktop_TowerAscend_ObstaclesCourse_CA_Tower_Ascend_Source_Tower_Ascend_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_FMurtagh_Desktop_TowerAscend_ObstaclesCourse_CA_Tower_Ascend_Source_Tower_Ascend_MovingPlatform_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
